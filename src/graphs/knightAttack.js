 ...
 * n, kr, kc, pr, pc
 *
 * n = the length of the chess board kr = the starting row of the knight kc
 * = the starting column of the knight pr = the row of the pawn pc = the
 * column of the pawn The function should return a number representing the
